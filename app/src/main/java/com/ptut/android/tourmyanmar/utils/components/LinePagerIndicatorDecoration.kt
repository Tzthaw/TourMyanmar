package com.ptut.android.myapplication.utils.components
...
open class LinePagerIndicatorDecoration : RecyclerView.ItemDecoration {
    ...
    private fun isLastItem(index: Int, recyclerView: RecyclerView) = index == recyclerView.adapter?.itemCount?.minus(1)
}